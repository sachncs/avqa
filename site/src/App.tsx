  ...
  return (
    <div className="relative min-h-screen bg-ink-950 text-ink-100">
      ...
      <div className="border-b border-accent-300/15 bg-accent-400/[0.06] px-6 py-2.5 text-center text-xs text-ink-300 sm:text-sm">
        <span className="font-semibold text-white">Public alpha · v0.1.0.</span> Validate performance and integrations against your own workload. <a className="ml-1 text-accent-200 underline-offset-4 hover:underline" href="/avqa/docs/">Read the docs →</a>
      </div>
      <Nav />
      <main>
        <Hero />
